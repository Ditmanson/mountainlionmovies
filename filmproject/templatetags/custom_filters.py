...
def get_similarity(similarity_scores, viewer_id):
    score = similarity_scores.get(viewer_id, 0)  # Default to 0 if the score is missing
    return f"{score * 100:.1f}%"  # Convert to percentage and format with one decimal place
