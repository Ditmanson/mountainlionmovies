...
const displayResults = (data) => {
  ...
  if (data.results) {
    data.results.forEach(movie => {
      ...
      const poster = movie.poster_path ? `${baseUrl}${movie.poster_path}` : 'https://images.unsplash.com/photo-1660922771242-c598e0808188?w=700&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8c29ycnl8ZW58MHx8MHx8fDA%3D';
