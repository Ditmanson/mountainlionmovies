...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (dropdown) {
        dropdown.addEventListener("mouseenter", fetchNotifications);
    } else {
        console.error("Element with id 'notificationDropdown' not found.");
    }
            ...
            .then(data => {
                ...
                if (unreadNotifications.length > 0) {
                    ...
                    unreadNotifications.forEach(notification => {
                        ...
                        } ${notification.notification_type} on ${new Date(
