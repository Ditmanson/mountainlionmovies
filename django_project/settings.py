...
SECRET_KEY = config(
    "SECRET_KEY",
    default="django-insecure-na_i!_poqmi%#b$a(2a75!4xx$v4hjjpss5nmty$0rtlrp3h^p",
)
...
CSRF_TRUSTED_ORIGINS = ["https://app-tditmans-5.devedu.io"]
...
DJANGO_CRON_CLASSES = ["filmproject.cron_jobs.DatabaseCleanupCronJob"]
